  ...
  <div class="ratings">
    <div class="ratings-content">
      ...
      <div class="rating-wrapper">
        <ul>
          <li class="rating-item" v-for="(rating, index) in filtersRatings" :key="index">
            <div class="avatar">
...
<script>
  ...
  export default {
    data(){
      return{
        selectType:0,// 选择显示类型 0 满意 1 不满意 2 全显示
        onlyContent:true,// 是否有内容
      }
    },
    computed:{
